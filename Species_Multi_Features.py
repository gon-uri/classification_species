...
for m in range(len(bird_species_list)):
    ...
    for z in range(len(files)):
        ...
        samp_rate, signal = sp.io.wavfile.read(files[z])
...
for j in range(len(bird_id_list)):
    if old_id == bird_id_list[j]+1:
        ax3.scatter(fou_max_list[j],fou_wid_list[j]+1,c=colors[bird_id_list[j]+1],s=200)
    else:
        ax3.scatter(fou_max_list[j],fou_wid_list[j]+1,c=colors[bird_id_list[j]+1],s=200,label=labels[bird_id_list[j]+1])
    ax3.annotate(str(bird_id_list[j]+1), (fou_max_list[j],fou_wid_list[j]+1))
    old_id = bird_id_list[j]+1
...
for j in range(len(bird_id_list)):
    if old_id == bird_id_list[j]+1:
        ax4.scatter(cr_max_list[j],cr_wid_list[j]+1,c=colors[bird_id_list[j]+1],s=200)
    else:
        ax4.scatter(cr_max_list[j],cr_wid_list[j]+1,c=colors[bird_id_list[j]+1],s=200,label=labels[bird_id_list[j]+1])
    ax4.annotate(str(bird_id_list[j]+1), (cr_max_list[j],cr_wid_list[j]+1))
    old_id = bird_id_list[j]+1
...
for j in range(len(bird_id_list)):
    if old_id == bird_id_list[j]+1:
        ax5.scatter(fou_entropy_list[j],cr_entropy_list[j],c=colors[bird_id_list[j]+1],s=200)
    else:
        ax5.scatter(fou_entropy_list[j],cr_entropy_list[j],c=colors[bird_id_list[j]+1],s=200,label=labels[bird_id_list[j]+1])
    ax5.annotate(str(bird_id_list[j]+1), (fou_entropy_list[j],cr_entropy_list[j]))
    old_id = bird_id_list[j]+1
